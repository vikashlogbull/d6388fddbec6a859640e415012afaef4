...
class siteenvironment extends Model {
    ...
    // Update site buckets
    public function updateSiteBucket($xrefid, $PublicFileBucket, $PrivateFileBucket)
    {
        if ($xrefid != null) {
            $siteenvitem = siteenvironment::find($xrefid);
            if ($siteenvitem != null) {
                $siteenvitem->update(array("public_files_bucket" => $PublicFileBucket, "private_files_bucket" => $PrivateFileBucket));
            } else {
               return null;
            }
        } else {
    ...
    // Update site Private Git Folder
    public function updateSitePrivateGitFolder($xrefid, $privateGitFolder)
    {
        if ($xrefid != null) {
            $siteenvitem = siteenvironment::find($xrefid);
            if ($siteenvitem != null) {
                $siteenvitem->update(array("private_git_folder" => $privateGitFolder));
            } else {
               return null;
            }
        } else {
